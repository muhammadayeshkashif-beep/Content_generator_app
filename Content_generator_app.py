...
# --- USER LOGIN SETUP ---
names = ["Ayesh", "Guest"]
usernames = ["ayesh", "guest"]
passwords = ["123", "guest123"]  # replace with secure ones
...
if authentication_status == False:
    ...
    # Put your actual app code below this line
    st.title("Unified Generator App")
    # your app’s existing code here
